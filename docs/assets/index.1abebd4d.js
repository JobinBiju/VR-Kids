...
function Rc(e, n, t, r, l, o, u, i, s) {
  (Ct = !1), (Rr = null), Lc.apply(Tc, arguments);
}
...
function nu(e, n, t, r) {
  if (Fr) {
    var l = po(e, n, t, r);
    if (l === null) Il(e, n, r, Ir, t), Gu(e, r);
...
var Ir = null;
function po(e, n, t, r) {
  if (((Ir = null), (e = Jo(r)), (e = kn(e)), e !== null))
...
var cf = A({}, Zt, {
  ...
  mf = we(pf),
  vf = A({}, ut, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  hf = we(vf),
  yf = A({}, tl, {
    deltaX: function (e) {
...
var Sf = We && 'TextEvent' in window && !_t,
  Ds = We && (!ou || (_t && 8 < _t && 11 >= _t)),
...
function Ef(e, n) {
  if (In)
    return e === 'compositionend' || (!ou && Fs(e, n))
      ? ((e = Ms()), (kr = tu = en = null), (In = !1), e)
      : null;
  switch (e) {
    case 'paste':
      return null;
...
function oi() {
  xt && (xt.detachEvent('onpropertychange', $s), (jt = xt = null));
}
function $s(e) {
  if (e.propertyName === 'value' && rl(jt)) {
    var n = [];
    js(n, jt, e, Jo(e)), gs(_f, n);
  }
}
function Nf(e, n, t) {
  e === 'focusin'
    ? (oi(), (xt = n), (jt = t), xt.attachEvent('onpropertychange', $s))
    : e === 'focusout' && oi();
}
function Pf(e) {
...
function ll(e) {
  ...
  var n = Un[e],
    t;
  for (t in n) if (n.hasOwnProperty(t) && t in Bs) return (Ol[e] = n[t]);
  return e;
}
  ...
  if (!e[cr]) {
    (e[cr] = !0),
      ts.forEach(function (t) {
        t !== 'selectionchange' && (Ff.has(t) || Fl(t, !1, e), Fl(t, !0, e));
      });
...
function hn() {
  if (!Ul && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Es(qo, hn), l);
    } finally {
      (O = n), (Ul = !1);
    }
  }
...
function No(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = ra), mu(e);
  var o = n.contextType;
  typeof o == 'object' && o !== null
    ? (l.context = _e(o))
...
function oa(e) {
  ...
  function S(f, a, d, h) {
    ...
    if (T.done) return t(f, x), j && wn(f, N), E;
    if (x === null) {
...
function Ea(e, n, t) {
  return (zn & 21) === 0
    ...
    : (Me(t, n) || ((t = xs()), ($.lanes |= t), (Ln |= t), (e.baseState = !0)),
      n);
}
function Kf(e, n) {
  var t = O;
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (j && t && iu(n), (n.flags |= 1), oe(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (j && r && iu(n), (n.flags |= 1), oe(e, n, t, l), n.child)
  );
}
function Ri(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Nr(e, n), la(n, t, r), No(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
function Oi(e, n, t, r, l) {
  return et(), au(l), (n.flags |= 256), oe(e, n, t, r), n.child;
}
...
function ed(e, n, t, r, l, o, u) {
  ...
  if (((i = (u & e.childLanes) !== 0), ce || i)) {
    ...
    return Lu(), (r = Hl(Error(y(421)))), mr(e, n, u, r);
  }
  return l.data === '$?'
    ? ((n.flags |= 128),
      (n.child = e.child),
  ...
  switch ((su(n), n.tag)) {
    ...
    case 13:
      if (
        ...
        if (j && ve !== null && (n.mode & 1) !== 0 && (n.flags & 128) === 0)
    ...
    case 4:
      return (
        tt(), Oo(e, n), e === null && $t(n.stateNode.containerInfo), te(n), null
      );
    case 10:
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[So], delete n[Vf], delete n[Bf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function pe(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Xu(t), n === 1))
      e.tag === 0 ? Hf(Ai.bind(null, e)) : Js(Ai.bind(null, e)),
        $f(function () {
          (R & 6) === 0 && hn();
        }),
        (t = null);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = wo(Sn.bind(null, e, ae, $e), n);
            break;
          }
          Sn(e, ae, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = wo(Sn.bind(null, e, ae, $e), r);
            break;
          }
          Sn(e, ae, $e);
          break;
...
function Tn(e) {
  ...
  try {
    ...
    (O = r), (Ce.transition = t), (R = n), (R & 6) === 0 && hn();
  }
}
function zu() {
  (me = Qn.current), F(Qn);
...
function qr(e, n) {
  ...
  while (1);
  if ((fu(), (R = t), (Gr.current = r), Q !== null)) throw Error(y(261));
  return (J = null), (b = 0), Y;
}
function ad() {
  for (; Q !== null; ) Ka(Q);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            No(n, r, e, t),
            (n = Lo(null, n, r, !0, o, t)))
          : ((n.tag = 0), j && o && iu(n), oe(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
      ...
      e: {
        ...
        if (((r = u.element), o.isDehydrated))
          if (
            ...
            (l = rt(Error(y(423)), n)), (n = Oi(e, n, r, t, l));
            break e;
          } else if (r !== l) {
            (l = rt(Error(y(424)), n)), (n = Oi(e, n, r, t, l));
            break e;
          } else
            for (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (bo(n, t | 1), pe(n, W()), (R & 6) === 0 && ((lt = W() + 500), hn()));
      }
      break;
    case 13:
      Tn(function () {
...
hs = Pu;
ys = Tn;
var kd = { usingClientEntryPoint: !1, Events: [Jt, $n, ol, ms, vs, Pu] },
  yt = {
...
ge.hydrateRoot = function (e, n, t) {
  ...
  if (
    ...
    (n = qa(n, null, e, 1, t != null ? t : null, l, !1, o, u)),
    (e[Qe] = n.current),
    $t(e),
    r)
  )
...
const Cd = '/assets/hamburger.62c2e62c.png';
var hl = { exports: {} },
  yl = {};
/**
 * @license React
...
function Rd() {
  return tn('nav', {
    ...
    children: [
      tn('h1', {
        className: 'main-logo',
        children: [Z('strong', { children: 'VR' }), 'Kids'],
      }),
      tn('ul', {
        className: 'nav-list',
        children: [
          Z('li', { className: 'nav-item', children: 'Products' }),
          Z('li', { className: 'nav-item', children: 'Apps & Games' }),
          Z('li', { className: 'nav-item', children: 'Features' }),
          Z('li', { className: 'nav-item', children: 'About' }),
        ],
      }),
      Z('div', {
        children: Z('h5', { className: 'sign-up', children: 'Sign Up' }),
      }),
      Z('img', { className: 'drawer', src: Cd }),
    ],
  });
}
const Od = '/assets/vr-1.d4426c2a.png';
function Md() {
  return tn('div', {
    className: 'main',
    children: [
      tn('div', {
        ...
        children: [
          tn('h1', {
            children: [
              'Best ',
              Z('strong', { className: 'text-grad', children: 'Educational' }),
            ],
          }),
          Z('h1', { children: 'VR Games' }),
          Z('h1', { children: 'For Your Kids' }),
          tn('div', {
            className: 'main-btns',
            children: [
              Z('h6', { className: 'btn-1', children: 'Explore Now' }),
              Z('h6', { className: 'btn-2', children: 'Browse Store' }),
            ],
          }),
        ],
      }),
      Z('img', { className: 'vr-img', src: Od, alt: 'vr-1' }),
    ],
  });
}
function Dd() {
  return tn(Td, { children: [Z(Rd, {}), Z(Md, {})] });
}
Yl.createRoot(document.getElementById('root')).render(
  Z(wc.StrictMode, { children: Z(Dd, {}) }),
);
